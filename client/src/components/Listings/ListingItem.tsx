      ...
      <Link to={`/listing/${listing.id}`}>
        <Info>
          ...
          <Item>
            ...
            <span className="label">{listing.numOfBedrooms} Habitaciones</span>
            <span className="icon">
              <FaBath />
            </span>
            <span className="label">{listing.numOfBaths} Baños</span>
            <span className="icon">
              <IoMdSquare />
            </span>
            <span className="label">{listing.propertySize} Metros Cuadrados</span>
          </Item>
        </Info>
      </Link>
    </ListItem>
